    ...
    if tweet1 and tweet2:
        try:
            ...
            with col1:
                ...
                st.markdown(f'<div class="green-opaque-box"><b>Tweet from Person 1:</b> {explanation_11}</div>', unsafe_allow_html=True)
                st.markdown(f'<div class="green-opaque-box"><b>Tweet from Person 1:</b> {explanation_12}</div>', unsafe_allow_html=True)
                st.markdown(f'<div class="green-opaque-box"><b>Tweet from Person 1:</b> {explanation_13}</div>', unsafe_allow_html=True)
                st.markdown(f'<div class="green-opaque-box"><b>Tweet from Person 1:</b> {explanation_14}</div>', unsafe_allow_html=True)
